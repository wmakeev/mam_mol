...
declare namespace $ {
	...
	type $mol_hotkey__mod_ctrl__8PODEZ88 = $mol_type_enforce<
		ReturnType< $mol_string['submit_with_ctrl'] >
		,
		ReturnType< $mol_hotkey['mod_ctrl'] >
	>
	type $mol_hotkey__key__SQDP46AZ = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_string__hint__FZINU3B2 = $mol_type_enforce<
		ReturnType< $mol_app_hello['name_hint'] >
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_string__value__VZ6UGMRK = $mol_type_enforce<
		ReturnType< $mol_app_hello['name'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_view__sub__CFPJSDNM = $mol_type_enforce<
		readonly(any)[]
		,
