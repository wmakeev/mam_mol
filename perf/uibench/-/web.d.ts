...
declare namespace $ {
	...
	type $mol_view__style__NS3KTPYS = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__P1RI7BH2 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__61ZVW4PT = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__VAYGHWTP = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['head_text'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__9IQXQWB4 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__ZYCMRNEB = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__6TZA9516 = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__4HCQ7UW9 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__JHEME7OT = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_table__state__VAQ3XMBW = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['table_state'] >
		,
		ReturnType< $mol_perf_uibench_table['state'] >
	>
	type $mol_perf_uibench_anim__state__3TDSQALV = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['anim_state'] >
		,
		ReturnType< $mol_perf_uibench_anim['state'] >
	>
	type $mol_perf_uibench_tree__state__0HQ4V5KF = $mol_type_enforce<
