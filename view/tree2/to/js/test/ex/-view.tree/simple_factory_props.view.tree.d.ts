declare namespace $ {
	...
	type $mol_view_tree2_to_js_test_ex_simple_factory_props_bar__some__15RB0VYP = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_view_tree2_to_js_test_ex_simple_factory_props_bar['some'] >
	>
	type $mol_view_tree2_to_js_test_ex_simple_factory_props_bar__loc__CEQYZDWR = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view_tree2_to_js_test_ex_simple_factory_props_bar['loc'] >
	>
	type $mol_view_tree2_to_js_test_ex_simple_factory_props_bar__deep__P3J8WDC3 = $mol_type_enforce<
		({ 
			'loc': string,
		}) 
		,
	...
	>
	type $mol_view_tree2_to_js_test_ex_simple_factory_props_bar__sub__PIUJZCUK = $mol_type_enforce<
		readonly(any)[]
		,
